...
`,V=function(e,t,n,a){var r,i=arguments.length,s=i<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,n):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,a);else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(s=(i<3?r(s):i>3?r(t,n,s):r(t,n))||s);return i>3&&s&&Object.defineProperty(t,n,s),s};let $=class extends a.oi{constructor(){super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=Y.state.exchanges,this.isLoading=Y.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=s.AccountController.state.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(Y.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(Y.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(s.AccountController.subscribe(e=>this.connectedWalletInfo=e.connectedWalletInfo)),Y.fetchExchanges()}get isWalletConnected(){return"connected"===s.AccountController.state.status}render(){return(0,a.dy)`
      ...
      >
        <wui-flex alignItems="center" gap="s">
          <wui-wallet-image
            ...
            name=${(0,i.o)(this.connectedWalletInfo?.name)}
          ></wui-wallet-image>
...
`,K=function(e,t,n,a){var r,i=arguments.length,s=i<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,n):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,a);else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(s=(i<3?r(s):i>3?r(t,n,s):r(t,n))||s);return i>3&&s&&Object.defineProperty(t,n,s),s};let z=class extends a.oi{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=Y.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return(0,a.dy)`
      <wui-flex
    ...
    `}getPaymentIcon(){let e=Y.state.currentPayment;if(e){if("exchange"===e.type){let t=e.exchangeId;if(t){let e=Y.getExchangeById(t);return e?.imageUrl}}if("wallet"===e.type){let e=s.AccountController.state.connectedWalletInfo?.icon;if(e)return e;let t=o.R.state.activeChain;if(!t)return;let n=F.ConnectorController.getConnectorId(t);if(!n)return;let a=F.ConnectorController.getConnectorById(n);if(!a)return;return H.f.getConnectorImage(a)}}}successTemplate(){return(0,a.dy)`<wui-icon size="xl" color="success-100" name="checkmark"></wui-icon>`}errorTemplate(){return(0,a.dy)`<wui-icon size="xl" color="error-100" name="close"></wui-icon>`}};async function q(e){return Y.handleOpenPay(e)}async function X(e,t=3e5){if(t<=0)throw new N(I.INVALID_PAYMENT_CONFIG,"Timeout must be greater than 0");try{await q(e)}catch(e){if(e instanceof N)throw e;throw new N(I.UNABLE_TO_INITIATE_PAYMENT,e.message)}return new Promise((e,n)=>{var a;let r=!1,i=setTimeout(()=>{r||(r=!0,o(),n(new N(I.GENERIC_PAYMENT_ERROR,"Payment timeout")))},t);function s(){if(r)return;let t=Y.state.currentPayment,n=Y.state.error,a=Y.state.isPaymentInProgress;if(t?.status==="SUCCESS"){r=!0,o(),clearTimeout(i),e({success:!0,result:t.result});return}if(t?.status==="FAILED"){r=!0,o(),clearTimeout(i),e({success:!1,error:n||"Payment failed"});return}!n||a||t||(r=!0,o(),clearTimeout(i),e({success:!1,error:n}))}let o=(a=[et("currentPayment",s),et("error",s),et("isPaymentInProgress",s)],()=>{a.forEach(e=>{try{e()}catch{}})});s()})}function J(){return Y.getExchanges()}function Z(){return Y.state.currentPayment?.result}function Q(){return Y.state.error}function ee(){return Y.state.isPaymentInProgress}function et(e,t){return Y.subscribeKey(e,t)}z.styles=j,K([(0,r.SB)()],z.prototype,"loadingMessage",void 0),K([(0,r.SB)()],z.prototype,"subMessage",void 0),K([(0,r.SB)()],z.prototype,"paymentState",void 0),z=K([(0,d.Mo)("w3m-pay-loading-view")],z);let en={network:"eip155:8453",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},ea={network:"eip155:8453",asset:"0x833589fcd6edb6e08f4c7c32d4f71b54bda02913",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},er={network:"eip155:84532",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},ei={network:"eip155:1",asset:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},es={network:"eip155:10",asset:"0x0b2c639c533813f4aa9d7837caf62653d097ff85",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},eo={network:"eip155:42161",asset:"0xaf88d065e77c8cC2239327C5EDb3A432268e5831",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},ec={network:"eip155:137",asset:"0x3c499c542cef5e3811e1192ce70d8cc03d5c3359",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},el={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},eu={network:"eip155:1",asset:"0xdAC17F958D2ee523a2206206994597C13D831ec7",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},em={network:"eip155:10",asset:"0x94b008aA00579c1307B0EF2c499aD98a8ce58e58",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},ed={network:"eip155:42161",asset:"0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},ep={network:"eip155:137",asset:"0xc2132d05d31c914a87c6611c10748aeb04b58e8f",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},ey={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}}},19017:function(e,t,n){n(16952)}}]);